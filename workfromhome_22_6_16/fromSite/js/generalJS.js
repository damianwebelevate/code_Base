...
$j('#showStepOneUserGuide').on("click", function(){
    window.parent.document.getElementById('stepOneUserGuide').style.display = "block";
});
...
$j('#backToColors, #backToColorsTwo').on("mouseenter", function(){
    $j('#backToColorsNumber, #backToColorsTwoNumber').addClass("grey");
    $j('#backToColorsText, #backToColorsTwoText').addClass("greyText");
});

$j('#backToColors, #backToColorsTwo').on("mouseleave", function(){
    $j('#backToColorsNumber, #backToColorsTwoNumber').removeClass("grey");
    $j('#backToColorsText, #backToColorsTwoText').removeClass("greyText");
});

$j('#backToColorsTwo').on("click", function(){
    var arr = window.parent.document.getElementsByTagName("iframe");
    for(var i = 0; i < arr.length; i++){
        var ident = arr[i].parentElement.id;
        window.parent.document.getElementById(ident).style.display = "none";
    }
        window.parent.document.getElementById("initial").style.display = "none";
        window.parent.document.getElementById("chooseColors").style.display = "block";
});
