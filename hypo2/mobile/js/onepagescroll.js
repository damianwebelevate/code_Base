...
function onePageScroll(element, options) {
  ...
  var defaults = {
      ...
      topMenu = document.getElementById("menu_area");
  ...
  this.init = function() { 
    ...
    /*-------------------------------------------*/
      ...
      if(settings.menu == true){
        console.log(settings.menuItems);
        for(var i = 0; i < settings.menuItems.length; i++){
          menuList += "<li><a data-index='" + (i + 1) + "' href='#" + (i + 1) + "'>"+settings.menuItems[i]+"</a></li>";
        }
      }
    ...
    if(settings.menu == true){
      var menuItself = document.createElement("ul");
      menuItself.setAttribute("class", "top-menu");
      topMenu.appendChild(menuItself);
      menuItself.innerHTML = menuList;
    }
      ...
      if(settings.menu == true) _addClass(document.querySelector(".top-menu li a" + "[data-index='" + init_index + "']"), "active")
      ...
      if(settings.menu == true) _addClass(document.querySelector(".top-menu li a[data-index='1']"), "active")
  	}
    ...
    if(settings.menu == true){
      var menu_links = document.querySelectorAll(".top-menu li a");
      for( var i = 0; i < menu_links.length; i++){
        menu_links[i].addEventListener('click', _menuHandler);
      }
    }
  ...
  /*---------------------------------*/
   ...
   this.moveDown = function(el3) {
    ...
    if(settings.menu == true){
      _removeClass(document.querySelector(".top-menu li a" + "[data-index='" + index + "']"), "active");
      _addClass(document.querySelector(".top-menu li a" + "[data-index='" + next_index + "']"), "active");
    }
  ...
  this.moveTo = function(el5, page_index) {
    ...
    if (typeof el5 == "string") el5 = document.querySelector(el5);
      ...
      _removeClass(document.querySelector(".top-menu li a" + ".active"), "active");
			_addClass(document.querySelector(".onepage-pagination li a" + "[data-index='" + (page_index) + "']"), "active");
      _addClass(document.querySelector(".top-menu-pagination li a" + "[data-index='" + (page_index) + "']"), "active");
