...
// create a subdirectory for each of the regions
$folderName = $region;
// add this to the filePath in session
$regionFolder = $fullPath."/";

// echo $regionFolder;
// echo "<br />";

// create directory if not exists (do you want to check session id?)

// echo "After check for if it is a directory <br />";
// echo $regionFolder;
// echo "<br />";
// echo $regionFolderTwo;
// echo "<hr />";


$parts    = explode(',', $_POST[$filename]);
$filepath = $regionFolder."/".$filename."_".$token.".png";
file_put_contents($filepath, base64_decode($parts[1]));


$fakePath = $regionFolder."/".$filename.".png";
...
if(isset($_POST[$imageUploaded])){
	...
	$imgSrc = "<img style='width: 97px; height: auto;' src='https://triplecrowncustom.com/wp-content/themes/triple/site/uploads/uploads/";
	$imgSrc .= $_POST[$imageUploaded];
	$imgSrc .= "'/>";


	$imgSrcTwo = "<img width=\"97\" align=\"right\" src=\"";
	$imgSrcTwo .= "https://triplecrowncustom.com/wp-content/themes/triple/site/uploads/uploads/";
	$imgSrcTwo .= $_POST[$imageUploaded];
	$imgSrcTwo .= "\"/>";

	// any image that was uploaded to the server
	$salesLinkToFile = "<a href=\"https://triplecrowncustom.com/wp-content/themes/triple/site/uploads/uploads/".$_POST[$imageUploaded]."\">Uploaded File Link</a>";
