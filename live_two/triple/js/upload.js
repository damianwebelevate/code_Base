(function(){
	...
	var checkFiles = document.getElementById('file_upload_normal').value;
		...
		app.uploader({
			...
			processor: 'https://triplecrowncustom.com/wp-content/themes/triple/site/uploads/upload.php',
			...
			finished: function(data){
				...
				for(i = 0; i < data.length; i++){
					...
					if(currFile.uploaded){
							...
							var fullRelative = "https://triplecrowncustom.com/wp-content/themes/triple/site/uploads/uploads/" + currFile.file;
