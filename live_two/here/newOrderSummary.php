								...
								<tbody>
									<tr>
										<td style="border: 1px solid #B8A14F;">
											<div style="height: 250px;">'.$image.'</div>
										</td>
									</tr>
								</tbody>
							</table></div>';
...
$forDisplayForm = '	<form id="newAddToCart" method="POST" action="https://triplecrowncustom.com/wp-content/themes/triple/site/addToCart.php">';
...
<script type="text/javascript" src="https://triplecrowncustom.com/wp-content/themes/triple/js/generalJS.js"></script>
