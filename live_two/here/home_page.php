		...
		<div class="wrapper"> -->
				...
				<div style="border-radius: 0px;" class="jumbotron homepage_jumbo">
					<div class="container-fluid marginTop">
						...
						<div class="col-md-12 col-lg-12 col-xs-12 col-sm-12 margin_top">
							<a href="https://triplecrowncustom.com/products-list/" rel="indexfollow" title="Stable Collection">
			...
			<section class="container-fluid">
				<div class="col-sm-4 col-md-4 col-xs-8 col-xs-offset-2 col-md-offset-0 col-lg-offset-0 col-sm-offset-0 nopadding">
					<a href="https://triplecrowncustom.com/our-riders/">
					<div class="thumbnail">
				...
				<div class="col-sm-4 col-md-4 col-xs-8 col-xs-offset-2 col-md-offset-0 col-lg-offset-0 col-sm-offset-0 nopadding">
					<a href="https://triplecrowncustom.com/products-list/">
					<div class="thumbnail">
