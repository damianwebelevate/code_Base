...
$j('#extendedNeckRegionImage img').on("mouseover", function(){
    ...
    $j('#extendedNeckRegionImage img').css("margin-top","0");
});
...
$j('#santaNeckRegionImage img').on("mouseover", function(){
    ...
    $j('#santaNeckRegionImage img').css("margin-top","0");
});
...
$j('#gulfNeckRegionImage img').on("mouseover", function(){
    ...
    $j('#gulfNeckRegionImage img').css("margin-top","0");
});
...
$j('#backToColors').on("click", function(){
    window.location.href = "https://triplecrowncustom.com/add-colors/";
});
...
$j('#backToEmbroidery').on("click", function(){
    window.location.href = "https://triplecrowncustom.com/add-text-and-images/";
});
