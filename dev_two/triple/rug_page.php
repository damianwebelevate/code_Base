...
// echo $baseBody ."<br />" .$baseBind."<br />".$basePipe."<br />";
		...
		<div class="container-fluid">
			<div id="main-content" class="main-content">
				<div id="content" class="site-content" role="main">
					...
					<form id="getName" action="http://dev.triplecrowncustom.com/dev/wp-content/themes/triple/site/getcolors.php" method="post">
...
<script type="text/javascript" src="http://dev.triplecrowncustom.com/dev/wp-content/themes/triple/js/canvas.js"></script>
