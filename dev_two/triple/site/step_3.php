...
<head>
	<title>Tripple Crown Custom</title>
		...
		<!--[if lt IE 9]>
	<script src="http://dev.triplecrowncustom.com/dev/wp-content/themes/twentyfourteen/js/html5.js"></script>
	<![endif]-->
	<link rel="icon" href="http://dev.triplecrowncustom.com/dev/wp-content/themes/triple/img/favicon.ico" type="image/x-icon" />
	<link rel="apple-touch-icon" sizes="57x57" href="http://dev.triplecrowncustom.com/dev/wp-content/themes/triple/img/apple-icon-57x57.png" />
	<link rel="apple-touch-icon" sizes="72x72" href="http://dev.triplecrowncustom.com/dev/wp-content/themes/triple/img/apple-icon-72x72.png" />
	<link rel="apple-touch-icon" sizes="114x114" href="http://dev.triplecrowncustom.com/dev/wp-content/themes/triple/img/apple-icon-114x114.png" />
	<link rel="apple-touch-icon" sizes="144x144" href="http://dev.triplecrowncustom.com/dev/wp-content/themes/triple/img/apple-icon-144x144.png" />
	<link rel="apple-touch-icon" sizes="144x144" href="http://dev.triplecrowncustom.com/dev/wp-content/themes/triple/img/apple-icon-228x228.png" />
	
	<link rel="stylesheet" href='https://maxcdn.bootstrapcdn.com/bootstrap/3.3.5/css/bootstrap.min.css' type="text/css" />
	
	<link rel="stylesheet" href='http://dev.triplecrowncustom.com/dev/wp-content/themes/twentyfourteen/style.css?ver=4.4.1' type="text/css" />

	<link rel="stylesheet" href='http://dev.triplecrowncustom.com/dev/wp-content/themes/triple/style.css?ver=4.4.1' type="text/css" />

	<link rel="stylesheet" href='http://fonts.googleapis.com/css?family=Playfair+Display+SC:400,700' type="text/css" />

	<link rel="stylesheet" href='http://dev.triplecrowncustom.com/dev/wp-content/themes/triple/css/main.css' type="text/css" />
				...
				<div class="row">
					<div class="col-xs-6 col-md-2 col-lg-2 col-sm-6">
						...
						<!-- <div class="social visible-lg visible-md hidden-sm hidden-xs">
						  <a href="https://www.facebook.com/TripleCrownCustom" target="_blank"><img src="http://dev.triplecrowncustom.com/dev/wp-content/themes/triple/img/facebook.png" width="32" title="Triple Crown Custom on Facebook" alt="Triple Crown Custom on Facebook"/></a>
						  <a href="https://www.twitter.com/TripleCrownCustom" target="_blank"><img src="http://dev.triplecrowncustom.com/dev/wp-content/themes/triple/img/twitter.png" width="32" title="Triple Crown Custom on Twitter" alt="Triple Crown Custom on Twitter"/></a>
						  <a href="https://www.youtube.com/user/triplecrowncustom" target="_blank"><img src="http://dev.triplecrowncustom.com/dev/wp-content/themes/triple/img/youtube.png" width="32" title="Triple Crown Custom on Youtube" alt="Triple Crown Custom on Youtube"/></a>
						</div> -->
					</div>
					<div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
						<header class="header">
							<a href="http://dev.triplecrowncustom.com/dev/" rel="home">
								<img class="image" src="http://dev.triplecrowncustom.com/dev/wp-content/themes/triple/img/tcc-logo.png"  alt="Triple Crown Custom">
							</a>
						</header>
					</div>
...
<li id="menu-item-1249" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1249"><a href="http://dev.triplecrowncustom.com/dev/">Home</a></li>
<li id="menu-item-1250" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1250"><a href="http://dev.triplecrowncustom.com/dev/about-us/">About Us</a></li>
<li id="menu-item-1256" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1256"><a href="http://dev.triplecrowncustom.com/dev/products-list/">Products List</a></li>
<li id="menu-item-1251" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1251"><a href="http://dev.triplecrowncustom.com/dev/award-blankets/">Award Blankets</a></li>
<li id="menu-item-1253" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1253"><a href="http://dev.triplecrowncustom.com/dev/our-riders/">Our Riders</a></li>
<li id="menu-item-1254" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1254"><a href="http://dev.triplecrowncustom.com/dev/sponsorshop/">Sponsorship</a></li>
<li id="menu-item-1252" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1252"><a href="http://dev.triplecrowncustom.com/dev/contact-us/">Contact Us</a></li>
</ul></div>				</nav>
			</div>
		</div><!-- /close wrapper -->
	</div> <!-- /close container-fluid -->
...
$( document ).ready(function() {
	...
	$('#customer_cc_fullname').blur(function(evt){
		var val = $(this).val();
		var sub = "'";
		if(val.indexOf(sub) > -1){
			alert("Credit card name cannot contain an apostrophe. Should your name contain this character on your card please omit for this payment process, thank you");
			$(this).val("");
			$(this).focus();
		}
	});

	$('#customer_cc_exp_year').blur(function(evt){
		var date = new Date();
		var year = parseInt(date.getFullYear());

		var val = parseInt($(this).val());
		if(val < year){
			alert("Your card has expired...<br />Please use another method to pay, thank you");
			$(this).val("");
			$(this).focus();
		}
	});
...
<script type="text/javascript">
	Stripe.setPublishableKey('pk_test_uIGseed5UONQJ9KbPMPAviBg');
					...
					$.ajax({
						...
						success: function(json) {
							if (json.error == 1) {
								...
								location.href = "http://dev.triplecrowncustom.com/dev/thank-you";
							}
						},
						error: function(evt) {
							$form.find('button').prop('disabled', false);
