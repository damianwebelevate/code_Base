...
switch($whichArea){
	...
	if(isset($_SESSION['embroidery_neck'])){
		...
		session_write_close();
		$region = "Neck";
		header("location: http://dev.triplecrowncustom.com/dev/embroidery?region=".$region);
	}else{
		$region = "Neck";
		header("location: http://dev.triplecrowncustom.com/dev/embroidery?region=".$region);
	}
...
$srcNeck = isset($_SESSION['embroidery_neck']) ? $_SESSION['embroidery_neck'] : "http://dev.triplecrowncustom.com/dev/wp-content/themes/triple/img/default.png";
$neckImageFromEmbroidery = '<img src="'.$srcNeck.'" class="backFromEmbroidery"/>';
$srcCenter = isset($_SESSION['embroidery_center']) ? $_SESSION['embroidery_center'] : "http://dev.triplecrowncustom.com/dev/wp-content/themes/triple/img/default.png";
$centerImageFromEmbroidery = '<img src="'.$srcCenter.'" class="backFromEmbroidery"/>';
$srcHip = isset($_SESSION['embroidery_hip']) ? $_SESSION['embroidery_hip'] : "http://dev.triplecrowncustom.com/dev/wp-content/themes/triple/img/default.png";
$hipImageFromEmbroidery = '<img src="'.$srcHip.'" class="backFromEmbroidery"/>';
$srcShoulder = isset($_SESSION['embroidery_shoulder']) ? $_SESSION['embroidery_shoulder'] : "http://dev.triplecrowncustom.com/dev/wp-content/themes/triple/img/default.png";
...
========================================================================================================================= -->
								...
								<div style="display: none;">
									...
									<form method="post" id="deleteNeckForm" action="http://dev.triplecrowncustom.com/dev/wp-content/themes/triple/site/delete.php">
										<input type="hidden" name="Delete_Neck" value="Delete Neck" />
									</form>
									<form method="post" id="deleteCenterForm" action="http://dev.triplecrowncustom.com/dev/wp-content/themes/triple/site/delete.php">
										<input type="hidden" name="Delete_Center" value="Delete Center" />
									</form>
									<form method="post" id="deleteShoulderForm" action="http://dev.triplecrowncustom.com/dev/wp-content/themes/triple/site/delete.php">
										<input type="hidden" name="Delete_Shoulder" value="Delete Shoulder" />
									</form>
									<form method="post" id="deleteHipForm" action="http://dev.triplecrowncustom.com/dev/wp-content/themes/triple/site/delete.php">
					                 	...
					                 	<div class="innerSidebar">
											...
											***************************************************************************** -->
											<div id="textEmbroideryHidden" class="boxContentContent">
												<form method="post" id="embroideryChoice" action="http://dev.triplecrowncustom.com/dev/add-text-and-images/">
...
<script src="http://dev.triplecrowncustom.com/dev/wp-content/themes/triple/js/html2canvas.js"></script>
<!-- src="http://dev.triplecrowncustom.com/dev/wp-content/themes/triple/js/embroideryPage.js" type="text/javascript" -->
<script src="http://dev.triplecrowncustom.com/dev/wp-content/themes/triple/js/generalJS.js" type="text/javascript" ></script>
