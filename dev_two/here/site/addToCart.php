...
if($_POST['total'] == "0"){
  header("location: http://dev.triplecrowncustom.com/dev/");
}else{
...
$partOneOfCart .= '
    ...
    <div class="bodyColorRow">
      ...
      <div class="cartRowRow">
        <form method="post" action="http://dev.triplecrowncustom.com/dev/triple-cart-page/">
...
//       // if add to cart write to the cart variable in the session and unset all of the session data after writing to table
      ...
      header('location: http://dev.triplecrowncustom.com/dev/triple-cart-page/');
      ...
      if(!(empty($_POST['buy']))){
        ...
        if(count($_SESSION['Cart']['Order']) > 1){
                ...
                header('location: http://dev.triplecrowncustom.com/dev/order-form/');
